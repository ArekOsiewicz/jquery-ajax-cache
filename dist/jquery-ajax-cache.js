	                            ...
	                            if (typeof cacheValidateFun === 'function') {
	                                if (cacheValidateFun.call(null, data, options)) {
	                                    ...
	                                    LZUTF8.compressAsync(JSON.stringify(data), {
	                                        ...
	                                        } else console.log("Compression error: " + error.message);
	                                    });
	                                }
	                            } else {
	                ...
	                return {
	                    send: function send(headers, completeCallback) {
	                        LZUTF8.decompressAsync(input, {
	                            ...
	                            } else console.log("Decompression error: " + error.message);
	                        });
	                    },
